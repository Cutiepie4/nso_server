...
public class MonsterTemplate {
	...
	public boolean isBoss() {
		if ((this.id >= 114 && this.id <= 116) || (this.id >= 138 && this.id <= 141) || this.id == 144
				|| (this.id >= 160 && this.id <= 167) || (this.id >= 198 && this.id <= 204)
				|| (this.id >= 209 && this.id <= 218) || (this.id >= 220 && this.id <= 234)) {
			return true;
		}
		return false;
	}
 ...
 * template\MonsterTemplate.class Java compiler version: 8 (52.0) JD-Core
 * Version: 1.1.3
 */